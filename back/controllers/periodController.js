...
export const createPeriod = async (req, res) => {
    try {
        ...
        if (active) {
            return res.status(400).json({ error: "Ya existe un periodo abierto. ciérralo antes de abrir uno nuevo." });
        }
...
export const closePeriod = async (req, res) => {
    ...
    try {
        ...
        console.log(`🔒 Periodo ${id} cerrado. ${rejectionResult.rowCount} solicitudes pendientes han sido rechazadas.`);
